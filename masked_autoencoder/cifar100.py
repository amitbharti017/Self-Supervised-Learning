...
def train_augmentation():
    ...
    [
        ...
        layers.Resizing(INPUT_SHAPE[0]+50,INPUT_SHAPE[0]+50),
...
history = mae_model.fit(train_ds, epochs=EPOCHS, validation_data=val_ds,callbacks=callbacks)
mae_model.save_weights("model_weights/final_model/cifar100/model8")
