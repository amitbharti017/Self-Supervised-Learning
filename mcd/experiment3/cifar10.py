...
mae_model.load_weights("model/model1")
...
for batch_idx in tqdm(range(num_batches)):
    ...
    for i in range(start_idx, end_idx):
        ...
        for j in range(num_mc_samples):
            img_encoder_outputs = mae_model.encoder(img_unmasked_embeddings, training=True)
            ...
            img_decoder_outputs = mae_model.decoder(img_decoder_inputs, training=True)
...
np.save('Ex3_cifar1075_svhn_confidences_mean', confidences_mean)
np.save('Ex3_cifar1075_svhn_confidences_std', confidences_std)
